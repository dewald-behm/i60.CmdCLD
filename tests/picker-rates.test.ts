...
const pane = readFileSync(join(__dirname, '..', 'src', 'renderer', 'src', 'components', 'settings', 'AutopilotPane.tsx'), 'utf-8')
...
const refineBlock = pane.slice(pane.indexOf('const REFINE_PICKS = ['), pane.indexOf('] as const'))
